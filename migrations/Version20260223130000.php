...
/**
 * Create address + user_avatar and remove legacy user_profile columns
 */
final class Version20260223130000 extends AbstractMigration
{
    ...
    {
        return 'Add dedicated address and user_avatar entities linked to user_profile.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_profile DROP photo, DROP address');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_profile ADD photo VARCHAR(255) DEFAULT NULL, ADD address VARCHAR(255) DEFAULT NULL');
