 ...
 *     log_path?: scalar|null, // Path where readable log file will be located // Default: "%kernel.logs_dir%/%kernel.environment%-readable.log"
 *     max_line_length?: int, // Max line length in log file // Default: 120
 *     prefix_length?: int, // Prefix length in log file // Default: 2
 *     ignored_routes?: list<scalar|null>,
 * }
 * @psalm-type DukecityCommandSchedulerConfig = array{
 *     scheduled_command_class?: scalar|null, // The entity class to use for scheduled commands. Must implement ScheduledCommandInterface. // Default: "Dukecity\\CommandSchedulerBundle\\Entity\\ScheduledCommand"
 *     doctrine_manager?: scalar|null, // Default: "default"
 *     log_path?: scalar|null, // Default: "%kernel.logs_dir%"
 *     lock_timeout?: scalar|null, // Default: false
 *     ping_back_provider?: scalar|null, // Default: null
 *     ping_back?: bool, // Default: true
 *     ping_back_failed?: bool, // Default: true
 *     monitor_mail?: list<scalar|null>,
 *     monitor_mail_subject?: scalar|null, // Default: "cronjob monitoring %%s, %%s"
 *     send_ok?: bool, // Default: false
 ...
 *     options?: array{
 *         create_unregistered_mappings?: bool,
 *         skip_constructor?: bool,
 *         use_substitution?: bool,
 *         ignore_null_properties?: bool,
 *         source_member_naming_convention?: scalar|null,
 *         property_accessor?: scalar|null,
 *     },
 * }
