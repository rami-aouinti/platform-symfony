...
final class LoadJobOfferTaxonomyData extends Fixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $skills = [
            ...
            'Skill-git' => ['uuid' => '61000000-0000-1000-8000-000000000007', 'name' => 'Git'],
            'Skill-docker' => ['uuid' => '61000000-0000-1000-8000-000000000008', 'name' => 'Docker'],
            'Skill-kubernetes' => ['uuid' => '61000000-0000-1000-8000-000000000009', 'name' => 'Kubernetes'],
            'Skill-terraform' => ['uuid' => '61000000-0000-1000-8000-000000000010', 'name' => 'Terraform'],
            'Skill-postgresql' => ['uuid' => '61000000-0000-1000-8000-000000000011', 'name' => 'PostgreSQL'],
            'Skill-python' => ['uuid' => '61000000-0000-1000-8000-000000000012', 'name' => 'Python'],
            'Skill-nodejs' => ['uuid' => '61000000-0000-1000-8000-000000000013', 'name' => 'Node.js'],
            'Skill-typescript' => ['uuid' => '61000000-0000-1000-8000-000000000014', 'name' => 'TypeScript'],
            'Skill-elasticsearch' => ['uuid' => '61000000-0000-1000-8000-000000000015', 'name' => 'Elasticsearch'],
        ];
        ...
        $languages = [
            ...
            'Language-es' => ['uuid' => '62000000-0000-1000-8000-000000000004', 'code' => 'es', 'name' => 'Español'],
            'Language-it' => ['uuid' => '62000000-0000-1000-8000-000000000005', 'code' => 'it', 'name' => 'Italiano'],
            'Language-pt' => ['uuid' => '62000000-0000-1000-8000-000000000006', 'code' => 'pt', 'name' => 'Português'],
            'Language-nl' => ['uuid' => '62000000-0000-1000-8000-000000000007', 'code' => 'nl', 'name' => 'Nederlands'],
        ];
        ...
        $jobCategories = [
            ...
            'JobCategory-mobile' => ['uuid' => '65000000-0000-1000-8000-000000000005', 'code' => 'mobile', 'name' => 'Mobile Development'],
            'JobCategory-qa' => ['uuid' => '65000000-0000-1000-8000-000000000006', 'code' => 'qa', 'name' => 'Quality Assurance'],
            'JobCategory-product' => ['uuid' => '65000000-0000-1000-8000-000000000007', 'code' => 'product', 'name' => 'Product Management'],
        ];
        ...
        $regions = [
            ...
            'Region-catalonia' => ['uuid' => '63000000-0000-1000-8000-000000000005', 'code' => 'CT', 'name' => 'Catalonia', 'countryCode' => 'ES'],
            'Region-madrid' => ['uuid' => '63000000-0000-1000-8000-000000000006', 'code' => 'MD', 'name' => 'Community of Madrid', 'countryCode' => 'ES'],
            'Region-lombardy' => ['uuid' => '63000000-0000-1000-8000-000000000007', 'code' => 'LOM', 'name' => 'Lombardy', 'countryCode' => 'IT'],
            'Region-north-holland' => ['uuid' => '63000000-0000-1000-8000-000000000008', 'code' => 'NH', 'name' => 'North Holland', 'countryCode' => 'NL'],
            'Region-lisbon' => ['uuid' => '63000000-0000-1000-8000-000000000009', 'code' => 'LIS', 'name' => 'Lisbon District', 'countryCode' => 'PT'],
            'Region-sao-paulo' => ['uuid' => '63000000-0000-1000-8000-000000000010', 'code' => 'SP', 'name' => 'São Paulo', 'countryCode' => 'BR'],
            'Region-quebec' => ['uuid' => '63000000-0000-1000-8000-000000000011', 'code' => 'QC', 'name' => 'Québec', 'countryCode' => 'CA'],
        ];
        ...
        $cities = [
            'City-paris' => ['uuid' => '64000000-0000-1000-8000-000000000001', 'name' => 'Paris', 'regionReference' => 'Region-idf'],
            'City-berlin' => ['uuid' => '64000000-0000-1000-8000-000000000002', 'name' => 'Berlin', 'regionReference' => 'Region-berlin'],
            'City-lyon' => ['uuid' => '64000000-0000-1000-8000-000000000003', 'name' => 'Lyon', 'regionReference' => 'Region-ara'],
            'City-toulouse' => ['uuid' => '64000000-0000-1000-8000-000000000004', 'name' => 'Toulouse', 'regionReference' => 'Region-occitanie'],
            'City-barcelona' => ['uuid' => '64000000-0000-1000-8000-000000000005', 'name' => 'Barcelona', 'regionReference' => 'Region-catalonia'],
            'City-madrid' => ['uuid' => '64000000-0000-1000-8000-000000000006', 'name' => 'Madrid', 'regionReference' => 'Region-madrid'],
            'City-milan' => ['uuid' => '64000000-0000-1000-8000-000000000007', 'name' => 'Milan', 'regionReference' => 'Region-lombardy'],
