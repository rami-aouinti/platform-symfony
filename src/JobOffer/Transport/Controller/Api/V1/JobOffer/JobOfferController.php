...
class JobOfferController extends Controller
{
    ...
    #[IsGranted(AuthenticatedVoter::IS_AUTHENTICATED_FULLY)]
    #[OA\RequestBody(required: true, content: new JsonContent(ref: '#/components/schemas/JobOfferRequest'))]
    #[OA\Response(response: 201, description: 'Job offer created', content: new JsonContent(ref: '#/components/schemas/JobOfferResponse'))]
    ...
    #[IsGranted(AuthenticatedVoter::IS_AUTHENTICATED_FULLY)]
    #[OA\RequestBody(required: true, content: new JsonContent(ref: '#/components/schemas/JobOfferRequest'))]
    #[OA\Response(response: 200, description: 'Job offer updated', content: new JsonContent(ref: '#/components/schemas/JobOfferResponse'))]
    ...
    #[IsGranted(AuthenticatedVoter::IS_AUTHENTICATED_FULLY)]
    #[OA\RequestBody(required: true, content: new JsonContent(ref: '#/components/schemas/JobOfferRequest'))]
    #[OA\Response(response: 200, description: 'Job offer patched', content: new JsonContent(ref: '#/components/schemas/JobOfferResponse'))]
