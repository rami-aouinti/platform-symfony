...
class ResumeExperience implements EntityInterface
{
    ...
    public function getEmploymentType(): ResumeEmploymentType { return $this->employmentType; }
    public function setEmploymentType(ResumeEmploymentType|string $employmentType): self { $this->employmentType = $employmentType instanceof ResumeEmploymentType ? $employmentType : ResumeEmploymentType::from($employmentType); return $this; }
