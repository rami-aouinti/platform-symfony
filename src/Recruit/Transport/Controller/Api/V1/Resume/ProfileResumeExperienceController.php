...
#[AsController]
#[Route(path: '/api/v1/me/profile/resumes/{resumeId}/experiences', requirements: ['resumeId' => Requirement::UUID_V1])]
#[IsGranted(new Expression("is_granted('IS_AUTHENTICATED_FULLY')"))]
#[OA\Tag(name: 'ResumeExperience Management')]
class ProfileResumeExperienceController extends Controller
{
    use FindOneMethod;
    use CreateMethod;
    use UpdateMethod;
    ...
    public function __construct(
        ResumeExperienceResourceInterface $resource,
    ...
    #[OA\Get(summary: 'List resume experiences')]
    ...
    #[OA\Post(summary: 'Create resume experiences item')]
    ...
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resume not found')]
    public function createAction(Request $request, ResumeExperienceCreate $restDto, string $resumeId): Response
    {
    ...
    #[OA\Get(summary: 'Get one resume experiences item')]
    ...
    #[OA\Put(summary: 'Update resume experiences item')]
    #[OA\RequestBody(required: true, content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 200, description: 'Updated', content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resource not found')]
    public function updateAction(Request $request, ResumeExperienceUpdate $restDto, string $resumeId, string $id): Response
    {
    ...
    #[OA\Patch(summary: 'Patch resume experiences item')]
    #[OA\RequestBody(required: true, content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 200, description: 'Patched', content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resource not found')]
    public function patchAction(Request $request, ResumeExperiencePatch $restDto, string $resumeId, string $id): Response
    {
        $restDto->setResume($this->assertChildBelongsToResume($resumeId, $id, Permission::RESUME_EDIT));
    ...
    #[OA\Delete(summary: 'Delete resume experiences item')]
