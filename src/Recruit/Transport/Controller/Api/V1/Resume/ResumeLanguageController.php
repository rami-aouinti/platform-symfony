...
#[AsController]
#[Route(path: '/api/v1/me/resumes/{resumeId}/languages', requirements: ['resumeId' => Requirement::UUID_V1])]
#[IsGranted(new Expression("is_granted('IS_AUTHENTICATED_FULLY')"))]
#[OA\Tag(name: 'ResumeLanguage Management')]
class ResumeLanguageController extends Controller
{
    ...
    protected static array $dtoClasses = [
        Controller::METHOD_CREATE => ResumeLanguageCreate::class,
        Controller::METHOD_UPDATE => ResumeLanguageUpdate::class,
        Controller::METHOD_PATCH => ResumeLanguagePatch::class,
    ];

    public function __construct(
        ResumeLanguageResourceInterface $resource,
    ...
    #[OA\Get(summary: 'List resume languages')]
    ...
    #[OA\Post(summary: 'Create resume languages item')]
    ...
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resume not found')]
    public function createAction(Request $request, ResumeLanguageCreate $restDto, string $resumeId): Response
    {
    ...
    #[OA\Get(summary: 'Get one resume languages item')]
    ...
    #[OA\Put(summary: 'Update resume languages item')]
    #[OA\RequestBody(required: true, content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 200, description: 'Updated', content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resource not found')]
    public function updateAction(Request $request, ResumeLanguageUpdate $restDto, string $resumeId, string $id): Response
    {
    ...
    #[OA\Patch(summary: 'Patch resume languages item')]
    #[OA\RequestBody(required: true, content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 200, description: 'Patched', content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resource not found')]
    public function patchAction(Request $request, ResumeLanguagePatch $restDto, string $resumeId, string $id): Response
    {
        $restDto->setResume($this->assertChildBelongsToResume($resumeId, $id, Permission::RESUME_EDIT));
    ...
    #[OA\Delete(summary: 'Delete resume languages item')]
