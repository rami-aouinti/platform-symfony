...
#[AsController]
#[Route(path: '/api/v1/me/profile/resumes/{resumeId}/skills', requirements: ['resumeId' => Requirement::UUID_V1])]
#[IsGranted(new Expression("is_granted('IS_AUTHENTICATED_FULLY')"))]
#[OA\Tag(name: 'ResumeSkill Management')]
class ProfileResumeSkillController extends Controller
{
    use FindOneMethod;
    use CreateMethod;
    use UpdateMethod;
    ...
    public function __construct(
        ResumeSkillResourceInterface $resource,
    ...
    #[OA\Get(summary: 'List resume skills')]
    ...
    #[OA\Post(summary: 'Create resume skills item')]
    ...
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resume not found')]
    public function createAction(Request $request, ResumeSkillCreate $restDto, string $resumeId): Response
    {
    ...
    #[OA\Get(summary: 'Get one resume skills item')]
    ...
    #[OA\Put(summary: 'Update resume skills item')]
    #[OA\RequestBody(required: true, content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 200, description: 'Updated', content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resource not found')]
    public function updateAction(Request $request, ResumeSkillUpdate $restDto, string $resumeId, string $id): Response
    {
    ...
    #[OA\Patch(summary: 'Patch resume skills item')]
    #[OA\RequestBody(required: true, content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 200, description: 'Patched', content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resource not found')]
    public function patchAction(Request $request, ResumeSkillPatch $restDto, string $resumeId, string $id): Response
    {
        $restDto->setResume($this->assertChildBelongsToResume($resumeId, $id, Permission::RESUME_EDIT));
    ...
    #[OA\Delete(summary: 'Delete resume skills item')]
