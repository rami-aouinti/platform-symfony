...
#[AsController]
#[Route(path: '/api/v1/me/resumes/{resumeId}/projects', requirements: ['resumeId' => Requirement::UUID_V1])]
#[IsGranted(new Expression("is_granted('IS_AUTHENTICATED_FULLY')"))]
#[OA\Tag(name: 'ResumeProject Management')]
class ResumeProjectController extends Controller
{
    ...
    protected static array $dtoClasses = [
        Controller::METHOD_CREATE => ResumeProjectCreate::class,
        Controller::METHOD_UPDATE => ResumeProjectUpdate::class,
        Controller::METHOD_PATCH => ResumeProjectPatch::class,
    ];

    public function __construct(
        ResumeProjectResourceInterface $resource,
    ...
    #[OA\Get(summary: 'List resume projects')]
    ...
    #[OA\Post(summary: 'Create resume projects item')]
    ...
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resume not found')]
    public function createAction(Request $request, ResumeProjectCreate $restDto, string $resumeId): Response
    {
    ...
    #[OA\Get(summary: 'Get one resume projects item')]
    ...
    #[OA\Put(summary: 'Update resume projects item')]
    #[OA\RequestBody(required: true, content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 200, description: 'Updated', content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resource not found')]
    public function updateAction(Request $request, ResumeProjectUpdate $restDto, string $resumeId, string $id): Response
    {
    ...
    #[OA\Patch(summary: 'Patch resume projects item')]
    #[OA\RequestBody(required: true, content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 200, description: 'Patched', content: new JsonContent(type: 'object'))]
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resource not found')]
    public function patchAction(Request $request, ResumeProjectPatch $restDto, string $resumeId, string $id): Response
    {
        $restDto->setResume($this->assertChildBelongsToResume($resumeId, $id, Permission::RESUME_EDIT));
    ...
    #[OA\Delete(summary: 'Delete resume projects item')]
