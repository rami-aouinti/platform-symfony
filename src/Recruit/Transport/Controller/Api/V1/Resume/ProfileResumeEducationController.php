...
#[AsController]
#[Route(path: '/v1/me/profile/resumes/{resumeId}/educations', requirements: [
    'resumeId' => Requirement::UUID_V1,
])]
#[IsGranted(new Expression("is_granted('IS_AUTHENTICATED_FULLY')"))]
#[OA\Tag(name: 'Me/Profile - ResumeEducation Management')]
class ProfileResumeEducationController extends Controller
{
    ...
    public function __construct(
        ResumeEducationResourceInterface $resource,
    ...
    #[OA\Get(summary: 'List resume educations')]
    ...
    #[OA\Post(summary: 'Create resume educations item')]
    ...
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resume not found')]
    public function createAction(Request $request, ResumeEducationCreate $restDto, string $resumeId): Response
    {
    ...
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resource not found')]
    public function updateAction(Request $request, ResumeEducationUpdate $restDto, string $resumeId, string $id): Response
    {
    ...
    #[OA\Response(response: 403, description: 'Forbidden')]
    #[OA\Response(response: 404, description: 'Resource not found')]
    public function patchAction(Request $request, ResumeEducationPatch $restDto, string $resumeId, string $id): Response
    {
        $restDto->setResume($this->assertChildBelongsToResume($resumeId, $id, Permission::RESUME_EDIT));
